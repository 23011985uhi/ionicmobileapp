...
@Component({
  selector: 'app-tab2-new-chat-button',
  templateUrl: './tab2newchatbutton.component.html',
  styleUrls: ['./tab2newchatbutton.component.scss'],
  standalone: true,
  imports: [IonIcon, IonFab, IonFabButton,IonButton,IonButtons]
})
export class NewChatButtonComponent2 {
